      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          <p className="text-sm text-secondary-text font-mono">
            © {new Date().getFullYear()} Aditya Pharande. All rights reserved.
          </p>
          <div className="flex items-center gap-2 text-xs text-secondary-text/60 font-mono">
            <span className="w-2 h-2 rounded-full bg-accent animate-pulse" />
            <span>Built with Next.js, Tailwind v4, and Framer Motion.</span>
          </div>
        </div>
