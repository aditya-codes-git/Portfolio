...
export const TerminalProjectCard: React.FC<TerminalProjectCardProps> = ({
  ...
  return (
    <div className="border border-border-subtle bg-card-alt p-4 rounded-sm max-w-none sm:max-w-sm w-full my-2 text-left font-mono select-none">
      ...
      <button
        ...
        className="inline-flex items-center justify-center min-h-[44px] sm:min-h-0 py-2 sm:py-0 gap-1.5 text-xs text-accent hover:text-[#00c291] transition-colors font-mono cursor-pointer outline-none focus:ring-1 focus:ring-accent"
      >
